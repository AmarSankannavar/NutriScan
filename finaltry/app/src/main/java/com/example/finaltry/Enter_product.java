...
public class Enter_product extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // txt_image = findViewById(R.id.txt_image);
        ...
        btn_image.setBackgroundColor(color);
        btn_txt.setBackgroundColor(color);
    ...
    private void processImage(Bitmap bitmap) {
        ...
        task.addOnSuccessListener(firebaseVisionText -> {
          ...
          //  txt_image.setText(text);
            if (!text.isEmpty()) {
                Intent i = new Intent(Enter_product.this, Gemini_API.class);
